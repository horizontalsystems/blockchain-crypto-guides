...
While some merchants are slowly starting to accept payments in Bitcoin, Ethereum and some stablecoins, the vast majority of retailers are still not on board. 
...
That said, there are some ways to spend your cryptocurrency. A number of companies provide debit cards which are tied to crypto on your balance. These cards can be used to pay anywhere where typical Visa and MasterCard cards are accepted. 
